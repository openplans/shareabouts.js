  ...
  describe('The CartoDB Backend', function() {
    ...
    describe('constructor', function() {
      it('creates a default table structure configuration', function() {
        ...
        assert.property(backend.tables, 'places');
        assert.property(backend.tables, 'surveys');
        assert.property(backend.tables, 'support');

        assert.equal(backend.tables.places.fields.length, 1);
        assert.equal(backend.tables.places.fields[0].name, 'user_token');
        assert.equal(backend.tables.surveys.fields.length, 1);
